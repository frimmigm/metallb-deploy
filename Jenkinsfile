pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/frimmigm/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('frimmigm-225')   // <---- Change this to match your kubernetes cluster credentials
    }
